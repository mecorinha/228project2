...
```{r}
# average weight grouped by type?
```
...
```{r}
# get count of pokemon in each generation and make a plot out of it! 
# I was thinking a ggplot barplot or line plot just to see the trend of new pokemon introduced per generation
```
